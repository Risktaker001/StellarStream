              ...
              <SlidePanel key={animKey} direction="enter" id={animKey}>
                ...
                {step < 3 && (
                  <div className="flex gap-3 mt-8">
                    ...
                    <button
                      onClick={goNext}
                      className="flex-1 rounded-2xl bg-cyan-400 py-3.5 font-body text-sm font-bold text-black transition hover:bg-cyan-300 hover:shadow-[0_0_0_2px_rgba(34,211,238,0.6),0_0_16px_rgba(34,211,238,0.3)]"
